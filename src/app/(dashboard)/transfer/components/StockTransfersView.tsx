      ...
      <Tabs defaultValue="active" className="w-full">
        <div className="w-full overflow-x-auto whitespace-nowrap scrollbar-hide border-b border-slate-200/60 bg-slate-50/50 p-1 mb-6">
          <TabsList className="h-auto p-0 bg-transparent flex w-max min-w-full rounded-none border-none gap-1">
            <TabsTrigger value="active" className="data-active:bg-[#001529] data-active:text-white data-active:shadow-md rounded-lg px-3 py-2 transition-all duration-300 gap-1.5 text-slate-500 font-bold text-[10px] uppercase tracking-tight group border border-slate-200 data-active:border-transparent hover:bg-white hover:text-[#001529] shadow-sm bg-slate-100/80">
              <ClockIcon className="h-3.5 w-3.5 mr-2 group-data-active:text-amber-500 transition-colors" />
              PENDING
            </TabsTrigger>
            <TabsTrigger value="history" className="data-active:bg-[#001529] data-active:text-white data-active:shadow-md rounded-lg px-3 py-2 transition-all duration-300 gap-1.5 text-slate-500 font-bold text-[10px] uppercase tracking-tight group border border-slate-200 data-active:border-transparent hover:bg-white hover:text-[#001529] shadow-sm bg-slate-100/80">
              <HistoryIcon className="h-3.5 w-3.5 mr-2 group-data-active:text-emerald-500 transition-colors" />
              HISTORY
            </TabsTrigger>
          </TabsList>
        </div>
